...
void EXTI0_IRQHandler(void) {
    ...
    // Kiểm tra xem cờ ngắt cho EXTI0 có đang được set không
    if (EXTI->PR & (1U << 0)) {
        EXTI->PR |= (1U << 0);
    }
}
...
void EXTI1_IRQHandler(void) {
    ...
    // Kiểm tra xem cờ ngắt cho EXTI1 có đang được set không
    if (EXTI->PR & (1U << 1)) {
        EXTI->PR |= (1U << 1);
    }
}
...
void EXTI2_IRQHandler(void) {
    ...
    // Kiểm tra xem cờ ngắt cho EXTI2 có đang được set không
    if (EXTI->PR & (1U << 2)) {
        EXTI->PR |= (1U << 2);
    }
}
